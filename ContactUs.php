                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="item phone">
                                ...
                                <h6>+91 9696969696<br><span>Phone Number</span></h6>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="item email">
                                <img src="assets/images/email-icon.png" alt="" style="max-width: 52px;">
                                <h6>yatifound@temp.co<br><span>Business Email</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <form id="contact-form" action="Includes/code.php?msg=add-contact" method="post">
                        <div class="row">
                            <div class="col-lg-12">
                                <fieldset>
                            ...
                            <div class="col-lg-12">
                                <fieldset>
                                    <button type="submit" id="form-submit" class="orange-button" name="btnContact">Send
                                        Message</button>
                                </fieldset>
                            </div>
                        </div>

...
<head>
    ...
    <title>Add News - Yati Foundation</title>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="../admin/code.php?msg=add-news" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="exampleInputTitle" class="form-label">News Title</label>
                                    <input type="text" class="form-control" id="exampleInputTitle" name="title">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputFile" class="form-label">Select File</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="exampleInputDesc" class="form-control"></textarea>
                                </div>
